...
url = "https://api.atlassian.com/admin/v1/orgs/0b5448b2-995d-4a3a-a60c-163bd88355b1/directory/groups/4b32d215-a76d-4ec4-b554-ba8efab927f5/memberships/"
 ...
 while retries < retry_limit:
  try:
   ...
   with open(file_name) as fp:
    ...
    print("", file=logfile)
    print("Confluence license cleanup. Started on:", current_time, file=logfile)
    print("Confluence license cleanup. Started on:", current_time)
    print('Reading file')
    time.sleep(1)

...
url = "https://api.atlassian.com/admin/v1/orgs/0b5448b2-995d-4a3a-a60c-163bd88355b1/directory/groups/1be68f39-69d0-49ed-bafa-81ce3f707017/memberships/"
 ...
 while retries < retry_limit:
  try:
   ...
   with open(file_name) as fp:
    ...
    print("", file=logfile)
    print("Jira Software license cleanup. Started on:", current_time, file=logfile)
    print("Jira Software license cleanup. Started on:", current_time)
    print('Reading file')
    time.sleep(1)
